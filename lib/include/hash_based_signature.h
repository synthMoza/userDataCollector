...
public:
    ...
    {
        return m_encryptor.Encrypt(m_hash_creator.CalculateHash(inputBlobStart, inputBlobEnd), key);
    }
};
...
public:
    ...
    {
        return m_decryptor.Decrypt(inputSignatureStart, inputSignatureEnd, key) == m_hash_creator.CalculateHash(inputBlobStart, inputBlobEnd);
    }
};
}
